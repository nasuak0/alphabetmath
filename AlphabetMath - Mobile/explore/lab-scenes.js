/* Lab study — cover-art scenes, ported from zmath/coverart.jsx to plain
   string-emitting JS (no React). Same geometry, same visual language:
   line art in one color over the tile gradient (white) or over paper
  ...
  function build(scene, C, casing) {
    ...
    if (scene === 'curves') {
      ...
      var rh = function (rcx, rcy, s, rot, o) {
        ...
        S.push('<polygon points="' + pts(p) + '" fill="' + F(o) + '" stroke="' + W(0.5) + '" stroke-width="1.8"' + CAP + '/>');
      };
